<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm4-1.aspx.cs" Inherits="WebApplication1.WebForm4_1" %>
...
<h1> 注册界面 </h1>
    ...
    <div>
        ...
        <asp:Button ID="Button1" runat="server" Text="完成注册" onclick="Button1_Click" />
  </div>
    </form>
</body>
</html>
